...
<body>
    ...
    include './navbar.php';
    ?>
    <div class="center mt-0 #6400ff white accent-3">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn #ffab00 amber accent-4">Transfer Money<i class="material-icons right ">attach_money</i></button></a></td>
                                    </tr>
                            <?php
                                }
                            }
