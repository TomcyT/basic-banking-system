...
<body>
    ...
    <div class="center mt-0 ">
        <h3><b><span></span>Few Steps To Go...</b></h3>
    </div>
    <div class="container-fluid">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <div class="text-center">
                <button class="btn mt-3 waves-effect waves-light #1a237e indigo darken-4" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
            <br>
        </form>
    </div>
